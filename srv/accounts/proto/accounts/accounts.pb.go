...
var file_proto_accounts_accounts_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x22, 0x1b, 0x0a, 0x07, 0x4d, 0x65,
	...
	0x6e, 0x74, 0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x2e, 0x50,
...
var file_proto_accounts_accounts_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_accounts_accounts_proto_goTypes = []interface{}{
	(*Message)(nil),           // 0: go.micro.service.accounts.Message
	(*Request)(nil),           // 1: go.micro.service.accounts.Request
	(*Response)(nil),          // 2: go.micro.service.accounts.Response
	(*StreamingRequest)(nil),  // 3: go.micro.service.accounts.StreamingRequest
	(*StreamingResponse)(nil), // 4: go.micro.service.accounts.StreamingResponse
	(*Ping)(nil),              // 5: go.micro.service.accounts.Ping
	(*Pong)(nil),              // 6: go.micro.service.accounts.Pong
}
var file_proto_accounts_accounts_proto_depIdxs = []int32{
	1, // 0: go.micro.service.accounts.Accounts.Create:input_type -> go.micro.service.accounts.Request
	3, // 1: go.micro.service.accounts.Accounts.Stream:input_type -> go.micro.service.accounts.StreamingRequest
	5, // 2: go.micro.service.accounts.Accounts.PingPong:input_type -> go.micro.service.accounts.Ping
	2, // 3: go.micro.service.accounts.Accounts.Create:output_type -> go.micro.service.accounts.Response
	4, // 4: go.micro.service.accounts.Accounts.Stream:output_type -> go.micro.service.accounts.StreamingResponse
	6, // 5: go.micro.service.accounts.Accounts.PingPong:output_type -> go.micro.service.accounts.Pong
