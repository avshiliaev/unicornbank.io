...
var file_proto_queries_queries_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x72, 0x69, 0x65, 0x73, 0x22, 0x20, 0x0a, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x72,
...
var file_proto_queries_queries_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_queries_queries_proto_goTypes = []interface{}{
	(*GenericEvent)(nil),      // 0: go.micro.service.queries.GenericEvent
	(*Request)(nil),           // 1: go.micro.service.queries.Request
	(*Response)(nil),          // 2: go.micro.service.queries.Response
	(*StreamingRequest)(nil),  // 3: go.micro.service.queries.StreamingRequest
	(*StreamingResponse)(nil), // 4: go.micro.service.queries.StreamingResponse
	(*Ping)(nil),              // 5: go.micro.service.queries.Ping
	(*Pong)(nil),              // 6: go.micro.service.queries.Pong
}
var file_proto_queries_queries_proto_depIdxs = []int32{
	1, // 0: go.micro.service.queries.Queries.Call:input_type -> go.micro.service.queries.Request
	3, // 1: go.micro.service.queries.Queries.Stream:input_type -> go.micro.service.queries.StreamingRequest
	5, // 2: go.micro.service.queries.Queries.PingPong:input_type -> go.micro.service.queries.Ping
	2, // 3: go.micro.service.queries.Queries.Call:output_type -> go.micro.service.queries.Response
	4, // 4: go.micro.service.queries.Queries.Stream:output_type -> go.micro.service.queries.StreamingResponse
	6, // 5: go.micro.service.queries.Queries.PingPong:output_type -> go.micro.service.queries.Pong
